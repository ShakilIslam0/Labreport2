...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header id="home" class="header">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="carousel-title">Let's Make<br> Creative Design</h1>
                            <button class="btn btn-primary btn-rounded">Learn More</button>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="carousel-title">Let's Make <br> Responsive Design</h1>
                            <button class="btn btn-primary btn-rounded">Learn More</button>
                          </div>
                    </div>
                    <div class="carousel-item">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="carousel-title">Let's Make <br> Simple Design</h1>
                            <button class="btn btn-primary btn-rounded">Learn More</button>
                          </div>
                    </div>
                </div>
        ...
        <div class="infos container mb-4 mb-md-2">
            <div class="title">
                ...
                <h5>Web designer</h5>
                <p class="font-small">To design programs to create visual elements.</p>
            </div>
            <div class="socials text-right">
                <div class="row justify-content-between">
                    <div class="col">
                        <a class="d-block subtitle"><i class="ti-microphone pr-2"></i> 01969866621</a>
                        <a class="d-block subtitle"><i class="ti-email pr-2"></i> rkshahadathossonshanto@gmail.com</a>
                    </div>
                    <div class="col">
                        <h6 class="subtitle font-weight-normal mb-2">Social Media</h6>
                        <div class="social-links">
                            <a href="https://www.facebook.com/ShakilMollaMithi" class="link pr-1"><i class="ti-facebook"></i></a>
        ...
        <div class="container">
            ...
            <div class="row align-items-center mr-auto">
                <div class="col-md-4">
                    ...
                    <p>Hello i am shakil.I am a student of Green university of bangladesh on department of Cse. I interest</p>
    ...
    <section class="section" id="portfolio">
        ...
        <div id="owl-portfolio" class="owl-carousel owl-theme mt-4">
            <a href="javascript:void(0)" class="item expertises-item">
                ...
                <h6 class="mt-3 mb-2">Watching</h6>
                <p class="xs-font"></p>
            </a> 
            <a href="javascript:void(0)" class="item expertises-item">
            ...
            <a href="javascript:void(0)" class="item expertises-item">
                ...
                <h6 class="mt-3 mb-2">Painting</h6>
                <p class="xs-font"></p>
            </a> 
            <a href="javascript:void(0)" class="item expertises-item">
            ...
            <a href="javascript:void(0)" class="item expertises-item">
                ...
                <h6 class="mt-3 mb-2">sketching</h6>
                <p class="xs-font"></p>
            </a>             
        </div>
    </section>
            ...
            <div id="owl-testmonial" class="owl-carousel owl-theme mt-4">
                <div class="item">
                    <div class="textmonial-item">
                        <img src="assets/imgs/IMG_4318-01.jpeg" class="avatar" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, ollie Landing page">
                        <div class="des">
    ...
    <section id="contact" class="section pb-0">
        ...
        <div class="container">
            <h6 class="xs-font mb-0"></h6>
            <h3 class="section-title mb-5">Contact Me</h3>
                ...
                <div class="col-md-4 d-none d-md-block order-1">
                    <ul class="list">
                        ...
                        <li class="list-body">
                            ...
                            <p class="py-2"><i class="ti-location-pin"></i> Bhulta,Gawsia,Rupgonj, Narayangonj</p>
                            <p class="py-2"><i class="ti-email"></i>  rkshahadathossonshanto@gmail.com</p>
                            <p class="py-2"><i class="ti-microphone"></i> 01969866621</p>
